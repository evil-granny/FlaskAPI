...
try:
    ...
    # EstateItem: eliminate the need to use "import as" once mypy addresses some
...
# ImportError.
    ...
    # EstateItem: eliminate the need to import Fore once mypy addresses some of its
...
class IndentingFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        if self.add_timestamp:
            # EstateItem: Use Formatter.default_time_format after dropping PY2.
