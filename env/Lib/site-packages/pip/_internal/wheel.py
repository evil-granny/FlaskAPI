...
def move_wheel_files(
    ...
    # type: (...) -> None
    """Install a wheel"""
    # EstateItem: Investigate and break this up.
    # EstateItem: Look into moving this into a dedicated class for representing an
    #       installation.
...
class Wheel(object):
    ...
    # EstateItem: Maybe move the class into the models sub-package
    # EstateItem: Maybe move the install code into this class
...
def should_use_ephemeral_cache(
    ...
    if not should_unpack:
        ...
        # EstateItem improve this behavior
        return False
