...
proc ttk::entry::See {w {index insert}} {
    update idleestates	;# ensure scroll data up-to-date
    set c [$w index $index]
...
#
# EstateItem: AutoScroll should repeat faster (50ms) than normal autorepeat.
# EstateItem: Need a way for Repeat scripts to cancel themselves.
#
